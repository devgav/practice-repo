  ...
  <?php
    ...
    if ( $project_query->have_posts() ) :
      while ( $project_query->have_posts() ) :
        ...
        $post_id = get_the_ID();
        $project_poster = get_post_meta($post_id, 'project_poster', true);
        $file_url = wp_get_attachment_url( $project_poster );
        $project_students = get_post_meta($post_id, 'project_students', true);
  ?>

    <div class="item" id="1">
      <div id="image_override">
        <?php the_post_thumbnail(); ?>
      </div>
      <div class="text">
      </div>
      <a data-fancybox="pdf-gallery" href="<?php echo $file_url?>">
